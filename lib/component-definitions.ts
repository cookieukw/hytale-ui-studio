import type { ComponentDefinition, PresetDefinition, HytaleComponent } from './hytale-types'
...
export function getComponentsByCategory(category: 'Layout' | 'Input' | 'Display'): ComponentDefinition[] {
